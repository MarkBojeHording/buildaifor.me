...
const MultiModal = () => {
  ...
  const analyzeFiles = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8003/api/analyze-files', {
        files: fileData
      });
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        {uploadedFiles.length > 0 && (
          ...
          >
            {isProcessing ? 'Analyzing Files with AI...' : 'Analyze All Files with AI'}
          </button>
        )}
      </div>
      ...
      {analysisResults && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <h3 className="font-semibold text-gray-900 mb-6">AI Analysis Results</h3>

          <div className="space-y-6">
            {/* Documents */}
            {analysisResults.documents && analysisResults.documents.length > 0 && (
              <div>
            ...
            {/* Audio */}
            {analysisResults.audio && analysisResults.audio.length > 0 && (
              <div>
                <h4 className="font-medium text-gray-900 mb-3 flex items-center">
