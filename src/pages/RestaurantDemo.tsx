...
import { ArrowLeft, MessageSquare, Clock, MapPin, Phone, Utensils } from 'lucide-react';
...
const RestaurantDemo = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "👋 Welcome to Bella Vista Restaurant! We serve authentic Italian cuisine in a warm, family atmosphere. How can I help you today?",
      isUser: false,
      timestamp: new Date()
    }
  ]);
  ...
  const quickReplies = [
    ...
    { text: "What's on your menu?", icon: Utensils },
    { text: "Do you take reservations?", icon: MessageSquare },
    { text: "Do you deliver?", icon: Phone }
  ];
  ...
  const sendMessage = async (messageText: string) => {
    ...
    try {
      const response = await fetch('http://localhost:8001/chat', {
        ...
        body: JSON.stringify({
          message: messageText,
          config: { client_id: 'demo-restaurant' },
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Bella Vista Restaurant Chatbot Demo
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience our basic FAQ chatbot in action. This Tier 1 chatbot provides essential information about hours, menu, reservations, and delivery.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-2">
              <Card className="h-[700px] flex flex-col">
                <CardHeader className="bg-gradient-to-r from-orange-600 to-red-600 text-white flex-shrink-0">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                      <Utensils className="w-6 h-6" />
                    </div>
                    <div>
                      <CardTitle className="text-white">Bella Vista Restaurant</CardTitle>
                    ...
                    {isLoading && (
                      <div className="flex justify-start">
                        <div className="bg-white border border-gray-200 rounded-2xl rounded-bl-sm px-4 py-3 max-w-xs">
                          ...
                          <p className="text-xs text-gray-500 mt-2">Restaurant assistant is typing...</p>
                        </div>
                      </div>
                    )}
                  </div>
                      ...
                      {quickReplies.map((reply, index) => {
                        ...
                        return (
                          <button
                            ...
                            disabled={isLoading}
                            className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-300 rounded-full text-sm text-gray-700 hover:bg-orange-50 hover:border-orange-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105"
                          >
                  ...
                  <form onSubmit={handleSubmit} className="p-3 border-t border-gray-200 flex-shrink-0 bg-white">
                    <div className="flex gap-2">
                      <input
                        ...
                        disabled={isLoading}
                        className="flex-1 px-4 py-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
                      />
                      <Button
                        type="submit"
                        disabled={!inputMessage.trim() || isLoading}
                        className="bg-orange-600 text-white p-3 rounded-2xl hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-300 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">456 Main Street, Downtown</p>
                  </div>
                  <div>
                    <p className="font-medium text-sm">Hours:</p>
                    <p className="text-sm text-gray-600">Mon-Thu 11AM-10PM, Fri-Sat 11AM-11PM, Sun 12PM-9PM</p>
                  </div>
                  <div>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">Menu & Hours</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2 text-sm text-gray-600">
                    <p>• Ask about restaurant hours</p>
                    <p>• Inquire about menu items</p>
                    <p>• Check reservation policies</p>
                    <p>• Ask about delivery options</p>
                  </div>
                </CardContent>
              </Card>
            </div>
